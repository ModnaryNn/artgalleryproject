	...
	INSERT INTO artists (fullname,about)
	VALUE 	("Vincent Van Gogh","This Dutch Post-Impressionist artist is considered to be one of the greatest painters of all time. ")
			, ("Leonardo da Vinci","The celebrated Italian polymath created some of the most famous paintings of all time.")
			, ("Salvador Dali","The king of Surrealism, Salvador Dali was a Spanish artist who explored the realm of the subconscious in his art.")
			, ("Edvard Munch","A Norwegian painter born in 1863, Edvard Munch was quite a tortured soul.")
			, ("Johannes Vermeer","This 17th century Dutch painter specialized in intimate domestic scenes, often portraying women.")
			, ("Claude Monet", "The iconic French Impressionist painter Claude Monet was a proponent of open-air landscape painting.")
	;
